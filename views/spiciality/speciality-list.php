...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/speciality/spiciality-list.css">
...
<body>
    ...
    <main>
        ...
        <header class="course_header">
            <h1>تمام تخصص های دسته برنامه نویسی</h1>
            <form action="">
        ...
        <section class="course_main_field">
            ...
            <div class="left_field">
                <a href="speciality-details.php" class="course_card">
                    <div class="card_img" style="background-image: url(../../assets/img/CI00.jpg);"></div>
                    <div class="card_content">
                        <p class="card_title">معمار داخلی شو</p>
                ...
                <a href="speciality-details.php" class="course_card">
                    ...
                    <div class="card_content">
                        <p class="card_title">طراح سایت حرفه ای شو</p>
                        <div class="card_detail">
                            <div><i class="fas fa-eye"></i>۱۰۲۳</div>
                        </div>
                        <img src="../../assets/img/CB00.svg" class="card_bg"></img>
