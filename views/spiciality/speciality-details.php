...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/speciality/speciality-details.css">
    ...
    <main>
        ...
        <section class="course_detail_main_field">
            <div class="right_field">
                ...
                <h3 class="main_title">درباره این تخصص</h3>
                <div class="AC_text">
                ...
                <div>
                    <h3 class="main_title">دوره های این تخصص</h3>

                    <div class="course_card_field">
                        <div class="card_field">
                            <div class="card_info">
                                <p>دوره اموزش طراحی سایت پیشرفته</p>
                                <div>
                                    <span><i class="fas fa-user-alt"></i>کسری حبیب بیگی</span>
                                    <span><i class="fas fa-eye"></i>۱۰۲۳</span>
                                </div>
                            </div>
                            <a href="../course/course-detail.php">مشاهده دوره</a>
                        </div>
                        <div class="card_field">
                            <div class="card_info">
                                <p>دوره اموزش طراحی دیتابیس مقدماتی</p>
                                <div>
                                    <span><i class="fas fa-user-alt"></i>کسری حبیب بیگی</span>
                                    <span><i class="fas fa-eye"></i>۱۰۲۳</span>
                                </div>
                        ...
                        <div class="card_field">
                            <div class="card_info">
                                <p>دوره اموزش طراحی سایت مقدماتی</p>
                                <div>
                                    <span><i class="fas fa-user-alt"></i>حمید آذرمکان</span>
                                    <span><i class="fas fa-eye"></i>۱۰۲۳</span>
                                </div>
                            </div>
                            <a href="../course/course-detail.php">مشاهده دوره</a>
                ...
                <div class="comments">
                    <h3 class="main_title">نظرات کاربران در رابطه با این تخصص</h3>
                    <form action="">
                ...
                <div class="course_info">
                    ...
                    <div class="course_details">
                        <div>
                            ...
                            <p>مدت زمان تخصص : <span> ۵۶ ساعت</span></p>
                        </div>
                        <div>
                            <i class="fas fa-layer-group"></i>
                            <p>سطح تخصص : <span>پیشرفته</span></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p>تعداد دوره ها : <span>۵۶</span></p>
                        </div>
                    </div>
                    <a href="">ثبت نام در تخصص</a>
                </div>
            </div>
        </section>
